execute if score SA_TRACKER SA_GAME_PHASE matches 1 run tellraw @a ["",{"selector":"@s"},{"text":" will be revived in "},{"score":{"name":"SA_TRACKER","objective":"SA_DEAD_M"}},{"text":" minutes.","color":"yellow"}]
