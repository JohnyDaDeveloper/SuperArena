...
scoreboard players operation SA_TRACKER SA_REM_HELP %= SA_TRACKER SA_5

execute if score SA_TRACKER SA_REM_HELP matches 0 unless score SA_TRACKER SA_PREP_REM_TIME matches 0 run tellraw @a ["",{"score":{"name":"SA_TRACKER","objective":"SA_PREP_REM_H"},"color":"yellow"},{"text":" hours and ","color":"yellow"},{"score":{"name":"SA_TRACKER","objective":"SA_PREP_REM_M"},"color":"yellow"},{"text":" minutes remaining.","color":"yellow"}]
