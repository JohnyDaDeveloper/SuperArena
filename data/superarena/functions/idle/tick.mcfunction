...
item replace entity @a hotbar.2 with minecraft:blue_wool{display:{Name:'{"text":"JOIN BLUE","color":"aqua","italic":false}'}} 1
...
execute as @a[nbt={SelectedItem:{id:"minecraft:blue_wool"}},team=!TEAM_BLUE] run function superarena:idle/join_blue
