...
execute if score SA_TRACKER SA_TEAM_WINNER matches 3 as @a[team=TEAM_YELLOW] at @s run function superarena:win/yellow_tick
execute if score SA_TRACKER SA_TEAM_WINNER matches 3 as @a[team=TEAM_WHITE] at @s run function superarena:win/white_tick
